...
Trained_model_path="logs_Resnet50AttentionFullAttentionAndBiasAllLayers/300000.torch" # If you want tos start from pretrained model
...
Net.eval()
#===========================================================================================================================
Sizes=[500,1000,2000,4000,8000,16000,32000,64000,128000,256000,500000,1000000] #sizes pixels
NumSizes=len(Sizes)
