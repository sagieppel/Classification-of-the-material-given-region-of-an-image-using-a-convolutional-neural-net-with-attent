...
import Resnet50AttentionFullAttentionAndBiasFirstLayers as Net
...
logs_dir= "logs_Resnet50AttentionFullAttentionAndBiasFirstLayers/"# "path to logs directory where trained model and information will be stored"
