...
import  Resnet50AttentionOnlyBiasMiddleLayer as Net
...
logs_dir= "Resnet50AttentionOnlyBiasMiddleLayer/"# "path to logs directory where trained model and information will be stored"
